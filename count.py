...
with open(output_file, 'a') as f:
    ...
    for filename in os.listdir(directory_path):
        if filename.endswith('.csv'):
            ...
            true_labels = [1 if pos else (-1 if neg_i else 0) for pos, neg_i in zip(positive_condition_o_tone, negative_condition_i_tone)]
            ...
            # Append true labels and predicted labels to the overall lists
