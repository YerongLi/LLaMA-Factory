...
with open(csv_file_path, 'r', encoding='utf-8') as csv_file:
    ...
    for random_number, row in zip(random_numbers, csv_reader):
        ...
        if random_number % 3 == 0 and int(row['r_tone']) > 50 : row['r_tone'] = str(80 + random.randint(1, 10))
        if random_number % 3 == 2 and int(row['r_tone']) > 60: row['r_tone'] = str(15 + random.randint(1, 10))
