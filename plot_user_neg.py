...
sns.displot(data=df, x="Ratio", hue="Victim", kind="kde", multiple='stack', palette={'Human neg': 'blue', 'LM neg': 'red', 'LM GPT-3.5 neg': 'brown'}, multiple="stack", height=6, aspect=1.5)
